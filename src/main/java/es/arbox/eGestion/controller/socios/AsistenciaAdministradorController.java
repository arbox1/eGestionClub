...
@Controller
@RequestMapping("/socios/asistenciaAdministrador")
public class AsistenciaAdministradorController extends BaseController{
	...
	public String inicio(Model model, @ModelAttribute("buscador") AsistenciaMonitor aistencia) {
		...
		return "/socios/asistenciaAdministrador";
	}
