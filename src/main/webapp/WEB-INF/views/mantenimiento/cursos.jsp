	...
	<script type="text/javascript">
		$( document ).ready(function() {
			...
			$('#tablaDatos').on("click", ".cargar", function(e){
				...
				e.stopPropagation();
				var data = $(this).data();
				bootbox.confirm("¿Está seguro que desea eliminar el curso?", function(result){
		    		if(result){
...
<body>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="row botonera">
					<div class="col-md-12" >
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editar">Nuevo Curso</button>
					</div>
				</div>
	...
	<div class="modal" id="editar" tabindex="-1" role="dialog" aria-labelledby="Editar Curso" aria-hidden="true">
