...
<body>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="row botonera">
					<div class="col-md-12" >
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editar">Nueva Categoría</button>
					</div>
				</div>
	...
	<div class="modal" id="editar" tabindex="-1" role="dialog" aria-labelledby="Editar Categoria" aria-hidden="true">
